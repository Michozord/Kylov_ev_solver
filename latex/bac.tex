...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//fourier/Figure_1.png}};
        ...
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) - (\xoffset, 0) $) {\includegraphics[width=0.4\textwidth]{latex//images//fourier/Figure_2.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//fourier/Figure_4.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        \pgfmathsetmacro{\xoffset}{0.002\textwidth}
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) - (\xoffset, 0) $) {\includegraphics[width=0.4\textwidth]{latex//images//fourier/Figure_5.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//cheb_coll/Figure_1.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        \pgfmathsetmacro{\xoffset}{0.002\textwidth}
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) - (\xoffset, 0) $) {\includegraphics[width=0.4\textwidth]{latex//images//cheb_coll/Figure_2.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//cheb_coll/Figure_3.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        \pgfmathsetmacro{\xoffset}{0.002\textwidth}
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) + (110pt, -60pt) $) {\includegraphics[width=0.45\textwidth]{latex//images//cheb_coll/Figure_4.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//cheb_coll/Figure_5.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        \pgfmathsetmacro{\xoffset}{0.002\textwidth}
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) - (\xoffset, 0) $) {\includegraphics[width=0.4\textwidth]{latex//images//cheb_coll/Figure_6.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//cheb_least_sq/Figure_1.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        \pgfmathsetmacro{\xoffset}{0.002\textwidth}
        \node[anchor=center, inner sep=0pt] (image2) at ($ (image1.center) - (\xoffset, 0) $) {\includegraphics[width=0.4\textwidth]{latex//images//cheb_least_sq/Figure_2.png}};
...
\end{figure}
% todo: add one more example like this
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//l2_minim/Figure_1.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        % Insert the second image below the first image on the left
        \node[anchor=north west, inner sep=0pt] (image2) at ($ (image1.south west) - (0, 0.5cm) $) {\includegraphics[height=0.4\textwidth]{latex//images//l2_minim/Figure_2.png}};
        ...
        \node[anchor=north east, inner sep=0pt] (image3) at ($ (image1.south east) - (0, 0.5cm) $) {\includegraphics[height=0.4\textwidth]{latex//images//l2_minim/Figure_3.png}};
...
\begin{figure}[h]
    ...
    \centering
    \begin{tikzpicture}
        \node[inner sep=0pt] (image1) at (0,0) {\includegraphics[width=\textwidth]{latex//images//l2_minim/Figure_4.png}};
        
        \pgfmathsetmacro{\imagewidth}{\textwidth}
        \pgfmathsetmacro{\imageheight}{\textwidth / \pgfkeysvalueof{/pgf/outer xsep} * \pgfkeysvalueof{/pgf/outer ysep}}
    
        % Insert the second image below the first image on the left
        \node[anchor=north west, inner sep=0pt] (image2) at ($ (image1.south west) - (0, 0.5cm) $) {\includegraphics[height=0.4\textwidth]{latex//images//l2_minim/Figure_5.png}};
        ...
        % Insert the third image below the first image on the left
        \node[anchor=north east, inner sep=0pt] (image3) at ($ (image1.south east) - (0, 0.5cm) $) {\includegraphics[height=0.4\textwidth]{latex//images//l2_minim/Figure_6.png}};
...
\begin{figure}[h!]
    $L=100, T=0.56$:\\
    \includegraphics[width=0.49\linewidth]{latex//images//simulation/Figure_3_100.png}
    \includegraphics[width=0.49\linewidth]{latex//images//simulation/Figure_2_100.png}
    $L=200, T=1.12$:\\
    \includegraphics[width=0.49\linewidth]{latex//images//simulation/Figure_3.png}
    \includegraphics[width=0.49\linewidth]{latex//images//simulation/Figure_2.png}
    \caption{Convergence of obtained resonances towards reference ones in the first 50 Krylov iterations for $L=100$ and $L=200$ time-steps per iteration. The filter function is constructed using the least squares method with 1000 Chebyshev knots, and target function $\chi_{\left[\omega_{\min}, \omega_{\max}\right]}$ with target intervals $[6,8]$ (right plots) and $ [11,13]$ (left plots).} 
...
In carried out experiments, we reduced the size of the problem from $N=629$ to $m=20$ or $m=50$ (by $L=200$ or $L=100$ time-steps per iteration, respectively) and obtained all eigenvalues in the target intervals with precision exceeding $10^{-5}$ with respect to the reference spectrum. 
...
Remedy to this disadvantage of the method is to employ more sample points in the controlled interval and use the least squares fitting instead of the collocation. The problem is well-conditioned independently on the degree of the polynomial by sampling in the Chebyshev knots, by other distribution of nodes the conditioning can be controlled by increasing number of nodes. Furthermore, we have proven, that the least squares method with equidistant nodes is equivalent to the fitting with respect to the $L^2$ norm (with integral replaced by the rectangle rule). In limes, by increasing number of the nodes, the solutions given by the least squares method, converge towards the $L^2$ error minimum.

In most cases we did not observe significant differences between presented method. By indicator function of the interval closer to 0 than to $\omega_\e$ (what is mostly the case in application) as the target function, the simplest way to construct the weight function remains the inverse Fourier transform method presented in Section \ref{section:fourier}. In some settings, this method displays undesirable behavior at the end of the controlled interval or the the peak of the function seems to be shifted from the target interval. Thus, in such cases best results yielded the least squares fitting in Chebyshev knots in $\omega^2$. It is simple to adjust number of nodes to avoid lying of the target interval between two next knots. Due to good conditioning of the problem, this method results in accurate filter function, also at the end of the controlled interval. Higher computational costs of this method are negligible, since computation of the weights is a preprocessing step and is not a part of the algorithm.

In carried out experiments in Chapter \ref{chapter:experiments} we computed the eigenvalues of the negative Laplace operator on the rectangular domain in $\R^2$ in two target intervals. Thanks to projection onto Krylov space obtained by appropriate filter function, we significantly reduced the size of the problem, and therefore also computational costs, without loss of exactness in the obtained eigenpairs. 
